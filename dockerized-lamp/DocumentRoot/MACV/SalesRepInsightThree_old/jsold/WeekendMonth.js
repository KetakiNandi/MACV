...
function WeekendMonth(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,POSType){
...
//var WEMUri=encodeURI("http://13.228.26.230/MACV/SalesRepInsightThree/data/WeekendMonth.php"); 
...
console.log("ffffffffff",links);
    	...
    	catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=(WEMUri+"?Siteparam="+sourceSite);
		d3.select("#WEMR").remove();
    	...
    	catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=(WEMUri+"?ProNameparam="+promoname);
			d3.select("#WEMR").remove();
	}
    	...
    	catgory && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=(WEMUri+"?categoryparam="+catgory);
			d3.select("#WEMR").remove();
    	...
    	catgory=== undefined && emp=== undefined && yesno=== undefined && subcat && POSType=== undefined)
    {
      ...
      links=(WEMUri+"?SubCatparam="+subcat);
    	...
    	catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType)
    {
      ...
      links=(WEMUri+"?POSTypeparam="+POSType);
    ...
    {
       links=encodeURI(WEMUri+"?startDate="+startDate+"&endDate="+endDate);
          //console.log(links);
          d3.select("#WEMR").remove();
    } 
/*
if (startDate,endDate === undefined && endDate === undefined){
          links=(WEMUri+"?param=");
        }
  else
    {
