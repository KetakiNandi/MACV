...
if($Sitename && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $Promoname && $POSTypeparam)
{
  ...
  $data = executeBlock($datessitecatPromoPostypefilterSession , 'datestatesourcesitecatpostypepromo');
  echo $data;
    }
...
else if($Sitename && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $EmpIdname && $POSTypeparam)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datessitecatSRPostypefilterSession , 'DateStateSourceSiteCatEmpPOS');
  echo $data;
    }
else if($Sitename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datessiteSRpostypefilterSession , 'datestatesourcesitepostypeemp');
  echo $data;
    }
else if($Sitename && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $POSTypeparam)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datessitecatPostypefilterSession , 'datestatesourcesitecatpostype');
  echo $data;
    }
else if($Sitename && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datessitepostypefilterSession , 'datestatesourcesitecatpostype');
  echo $data;
    }
else if($Sitename && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $EmpIdname)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datessitecatSRfilterSession , 'DateStateSourceSiteCatEmpPOS');
  echo $data;
    }
...
else if($Sitename && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $Promoname)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datessitecatpromofilterSession , 'datestatesourcesitecatpostypepromo');
  echo $data;
    }
else if($Sitename && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datessitecatfilterSession , 'datestatesourcesitecatpostype');
  echo $data;
    }
...
else if($Cityname && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $Promoname && $POSTypeparam)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datecitycatpostypepromofilterSession , 'DateStateCityCatPromoPOS');
  echo $data;
    }
...
else if($Cityname && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $EmpIdname && $POSTypeparam)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datecitycatSRpostypefilterSession , 'DateStateCityCatSRPOS');
  echo $data;
    }
else if($Cityname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datecitySRpostypefilterSession , 'DateStateCityCatSRPOS');
  echo $data;
    }
else if($Cityname && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $POSTypeparam)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datecitycatpostypefilterSession , 'DateStateCityCatSRPOS');
  echo $data;
    }
else if($Cityname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datecitypostypefilterSession , 'DateStateCityCatSRPOS');
  echo $data;
    }
else if($Cityname && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $EmpIdname)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datecitycatSRfilterSession , 'DateStateCityCatSRPOS');
  echo $data;
    }
else if($Cityname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datecitySRfilterSession , 'DateWiseStateWiseSRWiseContributionValue');
  echo $data;
    }
else if($Cityname && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $Promoname)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datecitycatpromofilterSession , 'DateStateCityCatPromoPOS');
  echo $data;
    }
else if($Cityname && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datecitycatfilterSession , 'DateStateCityCatSRPOS');
  echo $data;
    }
else if($Cityname && $_SESSION['stDate'] && $_SESSION['endDate'])
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datecityfilterSession , 'DateWiseStateWiseSRWiseContributionValue');
  echo $data;
    }
else if($zonename && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $Promoname && $POSTypeparam)
{
  ...
  //         }
  //         echo json_encode($data);
   $data = executeBlock($datezonecatpostypepromofilterSession , 'DateZoneWiseStateWiseCatPromoPOS');
  echo $data;
    }
...
else if($zonename && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $EmpIdname && $POSTypeparam)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datezonecatSRpostypefilterSession , 'DateZoneWiseStateWiseCatSRPOS');
  echo $data;
    }
else if($zonename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datezoneSRpostypefilterSession , 'DateZoneWiseStateWiseCatSRPOS');
  echo $data;
    }
else if($zonename && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $POSTypeparam)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datezonecatpostypefilterSession , 'DateZoneWiseStateWiseCatSRPOS');
  echo $data;
    }
else if($zonename && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datezonepostypefilterSession , 'DateZoneWiseStateWiseCatSRPOS');
  echo $data;
    }
else if($zonename && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $EmpIdname)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datezonecatSRfilterSession , 'DateZoneWiseStateWiseCatSRPOS');
  echo $data;
    }
else if($zonename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datezoneSRfilterSession , 'DateZoneWiseStateWiseCatSRPOS');
  echo $data;
    }
else if($zonename && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $Promoname)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datezonecatpromofilterSession , 'DateZoneWiseStateWiseCatPromoPOS');
  echo $data;
    }
else if($zonename && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname)
{
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datezonecatfilterSession , 'DateZoneWiseStateWiseCatSRPOS');
  echo $data;
    }
else if($zonename && $_SESSION['stDate'] && $_SESSION['endDate'])
{
  ...
  //         }
  //         echo json_encode($data);
   $data = executeBlock($datezonefilterSession , 'DateZoneWiseState');
  echo $data;
    }
 ...
 //          }
 //          echo json_encode($data);
    $data = executeBlock($dateempcatpostypepromofilterSession , 'datestatecatpromopostypeemp');
  echo $data;
  }
 ...
 //          }
 //          echo json_encode($data);
     $data = executeBlock($dateempcatpostypefilterSession , 'DateStateSourceSiteCatEmpPOS');
  echo $data;
  }
 ...
 //          }
 //          echo json_encode($data);
    $data = executeBlock($dateempcatpromofilterSession , 'datestatecatpromopostypeemp');
  echo $data;
  }
 ...
 //          }
 //          echo json_encode($data);
    $data = executeBlock($dateempcatfilterSession , 'datestatecatpostypeemp');
  echo $data;
  }
 ...
 //          echo json_encode($data);
...
else if($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam && $Promoname)
  {
    ...
    //       }
    //       echo json_encode($data);
    $data = executeBlock($datecatpostypepromofilterSession , 'datestatecatpromopostype');
  echo $data;
  }
else if($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $Promoname)
  {
    ...
    //       }
    //       echo json_encode($data);
    $data = executeBlock($datecatpromofilterSession , 'datestatecatpromopostype');
  echo $data;
  }
else if($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam)
  {
    ...
    //       }
    //       echo json_encode($data);
    $data = executeBlock($datecatpostypefilterSession , 'datestatecatpostypeemp');
  echo $data;
  }
else if($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'])
  {
    ...
    //       }
    //       echo json_encode($data);
    $data = executeBlock($datecatfilterSession , 'datestatecatpromopostype');
  echo $data;
  }
else if($POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate'])
  {
    ...
    //       }
    //       echo json_encode($data);
    $data = executeBlock($datepostypefilterSession , 'datestatecatpromopostype');
  echo $data;
  }
else if($startDate && $endDate)
 {
  ...
  //         }
  //         echo json_encode($data);
  $data = executeBlock($datefilter , 'DateWiseStateWiseSalesPerformanceQtn');
  echo $data;
         }
    ...
    //       }
    //       echo json_encode($data);
      $data = executeBlock($SubCatparamfilter , 'StateWiseSubCatWisePerformanceQtn');
  echo $data;
    }     
    ...
    //       }
    //      echo json_encode($data);
      $data = executeBlock($itemcodeparamfilter , 'TopTenSellingWiseState');
  echo $data;
    }     
else 
{
