...
$result= executeBlock($datessitecatPostypefilterSession,'DateSourceSiteWiseCatWisePOSTypeWiseTotalPOSCount');
echo  $result;
...
$result= executeBlock($datessitepostypefilterSession,'DateWiseSourceSiteWisePOSTypeWiseTotalPOSCount');
echo  $result;
...
$result= executeBlock($datessitecatfilterSession,'DateWiseSourceSiteWiseCategoryWiseTotalPOSCount');
echo  $result;
}
...
$result= executeBlock($datessitefilterSession,'DateWiseSourceSiteWiseTotalPOSCount');
echo  $result;
...
$result= executeBlock($datecitycatPostypefilterSession,'DateCityWiseCatWisePOSTypeWiseTotalPOSCount');
echo  $result;
}
else if ($Cityname && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate']){ // DONE
  //echo "<pre>"; print_r($_SESSION['stDate']);die;

$result= executeBlock($datecitypostypefilterSession,'DateWiseCityWisePOSTypeWiseTotalPOSCount');
echo  $result;
}
else if ($Cityname && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate']){ // DONE
  //echo "<pre>"; print_r($_SESSION['stDate']);die;

$result= executeBlock($datecitycatfilterSession,'DateWiseCityWiseCategoryWiseTotalPOSCount');
echo  $result;
}
else if ($Cityname && $_SESSION['stDate'] && $_SESSION['endDate']){ // DONE
  //echo "<pre>"; print_r($_SESSION);die; 
$result= executeBlock($datecityfilterSession,'DateWiseCityWiseTotalPOSCount');
echo  $result;
...
$result= executeBlock($datestatecatPostypefilterSession,'DateStateWiseCatWisePOSTypeWiseTotalPOSCount');
echo  $result;
}
...
$result= executeBlock($datestatepostypefilterSession,'DateWiseStateWisePOSTypeWiseTotalPOSCount');
echo  $result;
}
...
$result= executeBlock($datestatecatfilterSession,'DateWiseStateWiseCategoryWiseTotalPOSCount');
echo  $result;
}
else if ($statename && $_SESSION['stDate'] && $_SESSION['endDate']){ // DONE
  //echo "<pre>"; print_r($statename);die;

$result= executeBlock($datestatefilterSession,'DateWiseStateWiseTotalPOSCount');
echo  $result;
...
$result= executeBlock($datezonecatPostypefilterSession,'DateZoneWiseCatWisePOSTypeWiseTotalPOSCount');
echo  $result;
}
...
$result= executeBlock($datezonepostypefilterSession,'DateWiseZoneWisePOSTypeWiseTotalPOSCount');
echo  $result;
}
else if ($zonename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate']){ // DONE
                        //echo "1111";
      //echo "<pre>"; print_r($datezonecatfilterSession);die; 
$result= executeBlock($datezonecatfilterSession,'DateWiseZoneWiseCategoryWiseTotalPOSCount');
echo  $result;
}
...
$result= executeBlock($datezonefilterSession,'DateWiseZoneWiseTotalPOSCount');
echo  $result;
...
$result= executeBlock($datecatPostypefilterSession,'DateWiseCategoryWisePOSTypeWiseTotalPOSCount');
echo  $result;
...
//  echo "<pre>"; print_r($categoryname);die;
  $result= executeBlock($datecatfilterSession,'DateWiseCategoryWiseTotalPOSCount');
  echo  $result;
  ...
  //echo "<pre>"; print_r($_SESSION);die;
    ...
    $result= executeBlock($dateposfilterSession,'DateWisePOSTypeWiseTotalPOSCount');
    echo  $result;
...
else
  {
          ...
          $result= executeBlock($datefilter,'DateWiseTotalPOSCount');
          echo  $result;
...
//		$milliseconds = $row->date->toDateTime();
  ...
  //              $data[$i]["Count"]    = $oldV+$row->Count;
            ...
            if($findCounter==0){
              $data[$i]     =  array("PosCode"=>trim($row->PosCode),"Count"=>1);
            } 
            else {
              $findCounter  = 0;
            }
