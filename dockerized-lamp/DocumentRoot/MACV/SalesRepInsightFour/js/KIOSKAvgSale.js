...
//console.log(startDate,endDate,zone,state,city,sourceSite,catgory,POSType)
	 ...
	 // console.log(MaxCount.value.Count);
	  ...
	  // console.log(AvgAmt+TwentyPercentOfAvgAmt);
	   ...
	   TotalAmt.forEach(function(e,i) {
		...
		{
			FinaldataGreen.push({'PosCode': e.PosCode,'PosName':e.PosName,'Total':e.Amount,'AVG':AvgAmt.toFixed(2)});
			...
			tabulateGreen(FinaldataGreen, ['PosCode','PosName','Total','AVG']);
		      }
		      else
			{
		...
		{
		 	FinaldataBlue.push({'PosCode': e.PosCode,'PosName':e.PosName,'Total':e.Amount,'AVG':AvgAmt.toFixed(2)});
			...
			tabulateBlue(FinaldataBlue, ['PosCode','PosName','Total','AVG']);
		    }
		    else
		    {
			...
			FinaldataRed.push({'PosCode': e.PosCode,'PosName':e.PosName,'Total':e.Amount,'AVG':AvgAmt.toFixed(2)});
			...
			tabulateRed(FinaldataRed, ['PosCode','PosName','Total','AVG']);
		     }
		     else
		      {
