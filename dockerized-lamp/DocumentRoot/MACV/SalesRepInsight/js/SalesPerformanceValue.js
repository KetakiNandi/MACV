...
function SalesPerformanceValue(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,itemcode,POSType){

	console.log("zone1",startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,itemcode,POSType)
...
//         console.log("111",links1);
     ...
     else if(startDate === undefined && endDate === undefined && zone === undefined && sourceSite && state === undefined && city===undefined && promoname===undefined && catgory===undefined && emp===undefined && yesno===undefined && subcat===undefined && itemcode===undefined && POSType===undefined)
    {
          ...
          console.log("ddddddd1",links)
          console.log("ddddddd2",links1)
          d3.select("#SPVR").remove();
    }
...
//console.log("ssssssssss",JSON.stringify(data))
        ...
        .attr("height", function(d) { return height - y(d.Count); })
         .on("mousemove", function(d){
          //console.log("!!!",d);
              ...
              div.html("<span style='color:#ffffff'>" +"Month: " +d.Month +"<br/>"+"Amounts: " +commaFormat(d.Count)+"</span>");           
          })
	...
	CategorywisePerformanceQuantityZoom(datefmt(firstDay),datefmt(lastDay));
       ...
       // PoSperformance(datefmt(firstDay),datefmt(lastDay));
	     ...
	     render_avgsessionZoom(datefmt(firstDay),datefmt(lastDay));
      ...
      svg.selectAll("dot")  
        ...
        console.log(d.Month);   
           ...
           div.style("left", d3.event.pageX+10+"px");
              div.style("top", d3.event.pageY-25+"px");
              div.style("display", "inline-block");
              div.html("<span style='color:#ffffff'>" +"Bill Date Month: " +d.Month +"<br/>"+"ASP: " +d.Amo.toFixed(2)+"</span>");             
            })          
        .on("mouseout", function(d) {   
            div1.transition()    
                .duration(500)    
...
svg.selectAll("text.bar")
  ...
  .text(function(d) { 
  ...
  else 
    {
      ...
      alert("Sales Performance-Value Data is Not Available for Selected Criteria");
     }
});
