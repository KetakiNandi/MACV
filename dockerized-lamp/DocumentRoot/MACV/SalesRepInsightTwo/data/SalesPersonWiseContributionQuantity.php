...
if ($Sitename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam && $categoryname){ //DONE
 ...
 $result= executeBlock($datessitecatSRPostypefilterSession,'DateSourceSiteCategoryWisePostypeSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($datessitecatSRfilterSession,'DateSourceSiteCategoryWiseSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($datessiteSRPostypefilterSession,'DateWisePosTypeWiseSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($datessiteSRfilterSession,'DateWiseSourceSiteWiseSRWiseContributionQtn');
echo  $result;
  ...
  $result= executeBlock($datessitecatpromoPostypefilterSession,'DateSourceSiteCategoryWisePromoPostypeSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($datessitecatPostypefilterSession,'DateSourceSiteCategoryWisePostypeSRWiseContributionQtn');
echo  $result;
}
...
$result= executeBlock($datessitecatpromofilterSession,'DateSourceSiteCategoryWiseSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($datessitepostypefilterSession,'DateWisePosTypeWiseSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($datessitecatfilterSession,'DateSourceSiteCategoryWiseSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($datessitefilterSession,'DateWiseSourceSiteWiseSRWiseContributionQtn');
echo  $result;
}
...
$result= executeBlock($datecitycatSRPostypefilterSession,'DateCityCategoryWisePostypeSRWiseContributionQtn');
echo  $result;
}
else if ($Cityname && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ // DONE
  //echo "<pre>"; print_r($_SESSION['stDate']);die;

$result= executeBlock($datecitycatSRfilterSession,'DateCityCategoryWiseSRWiseContributionQtn');
echo  $result;
}
else if ($Cityname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam){ // DONE
  //echo "<pre>"; print_r($_SESSION['stDate']);die;

$result= executeBlock($datecitySRPostypefilterSession,'DateCityPosTypeWiseSRWiseContributionQtn');
echo  $result;
}
else if ($Cityname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ // ************************************
  //echo "<pre>"; print_r($_SESSION['stDate']);die;

$result= executeBlock($datecitySRfilterSession,'DateWiseSRWiseContributionQtn');
echo  $result;
}
else if ($Cityname && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $Promoname && $POSTypeparam){ // **********
  //echo "<pre>"; print_r($_SESSION['stDate']);die;

$result= executeBlock($datecitycatpromoPostypefilterSession,'DateCityCategoryWisePromoPostypeSRWiseContributionQtn');
echo  $result;
}
else if ($Cityname && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $Promoname){ // *************************
  //echo "<pre>"; print_r($_SESSION['stDate']);die;

$result= executeBlock($datecitycatpromofilterSession,'DateCityCategoryPromoWiseSRWiseContributionQtn');
echo  $result;
}
else if ($Cityname && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname){ // **********************
  //echo "<pre>"; print_r($_SESSION['stDate']);die;

 $result= executeBlock($datecitycatPostypefilterSession,'DateCityCategoryWisePostypeSRWiseContributionQtn');
echo  $result;
}
else if ($Cityname && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate']){ // *********************************
  //echo "<pre>"; print_r($_SESSION['stDate']);die;

$result= executeBlock($datecitypostypefilterSession,'DateCityPosTypeWiseSRWiseContributionQtn');
echo  $result;
}
else if ($Cityname && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate']){ // ***********************************
  //echo "<pre>"; print_r($_SESSION['stDate']);die;

$result= executeBlock($datecitycatfilterSession,'DateCityCategoryWiseSRWiseContributionQtn');
echo  $result;
}
else if ($Cityname && $_SESSION['stDate'] && $_SESSION['endDate']){ // ***********************************
  //echo "<pre>"; print_r($_SESSION);die;

 $result= executeBlock($datecityfilterSession,'DateWiseSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($datestatecatSRPostypefilterSession,'DateStateCategoryWisePostypeSRWiseContributionQtn');
echo  $result;
}
else if ($statename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ // DONE
  //echo "<pre>"; print_r($str_explodeStateSession);die;

$result= executeBlock($datestatecatSRfilterSession,'DateStateCategoryWiseSRWiseContributionQtn');
echo  $result;
}
else if ($statename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam){ // DONE
  //echo "<pre>"; print_r($str_explodeStateSession);die;

 $result= executeBlock($datestateSRPostypefilterSession,'DateStatePosTypeWiseSRWiseContributionQtn');
echo  $result;
}
else if ($statename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ // DONE
  //echo "<pre>"; print_r($str_explodeStateSession);die;

$result= executeBlock($datestateSRfilterSession,'DateWiseStateWiseSRWiseContributionQtn');
echo  $result;
}
else if ($statename && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $Promoname){ // ***********
  //echo "<pre>"; print_r($str_explodeStateSession);die;

$result= executeBlock($datestatecatpromoPostypefilterSession,'DateStateCategoryWisePromoPostypeSRWiseContributionQtn');
echo  $result;
}
else if ($statename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $Promoname){
  //echo "<pre>"; print_r($str_explodeStateSession);die;

  $result= executeBlock($datestatecatpromofilterSession,'DateStateCategoryPromoWiseSRWiseContributionQtn');
echo  $result;
}
else if ($statename && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname){ // ************************
  //echo "<pre>"; print_r($str_explodeStateSession);die;

$result= executeBlock($datestatecatPostypefilterSession,'DateStateCategoryWisePostypeSRWiseContributionQtn');
echo  $result;
}
else if ($statename && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate']){ // ********************
  //echo "<pre>"; print_r($str_explodeStateSession);die;

$result= executeBlock($datestatepostypefilterSession,'DateStatePosTypeWiseSRWiseContributionQtn');
echo  $result;
}
else if ($statename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate']){ // *************************
  //echo "<pre>"; print_r($str_explodeStateSession);die;

$result= executeBlock($datestatecatfilterSession,'DateStateCategoryWiseSRWiseContributionQtn');
echo  $result;
}
else if ($statename && $_SESSION['stDate'] && $_SESSION['endDate']){ // ****************************************
  //echo "<pre>"; print_r($statename);die;

 $result= executeBlock($datestatefilterSession,'DateWiseStateWiseSRWiseContributionQtn');
echo  $result;
 ...
 $result= executeBlock($datezonecatSRPostypefilterSession,'DateZoneCategoryWisePostypeSRWiseContributionQtn');
echo  $result;
}
...
$result= executeBlock($datezonecatSRfilterSession,'DateZoneCategoryWiseSRWiseContributionQtn');
echo  $result;
}
...
$result= executeBlock($datezoneSRPostypefilterSession,'DateZonePosTypeWiseSRWiseContributionQtn');
echo  $result;
}
...
$result= executeBlock($datezoneSRfilterSession,'DateWiseZoneWiseSRWiseContributionQtn');
echo  $result;
}
...
$result= executeBlock($datezonecatpromoPostypefilterSession,'DateZoneCategoryWisePromoPostypeSRWiseContributionQtn');
echo  $result;
}
...
$result= executeBlock($datezonecatpromofilterSession,'DateZoneCategoryPromoWiseSRWiseContributionQtn');
echo  $result;
}
 ...
 $result= executeBlock($datezonecatPostypefilterSession,'DateZoneCategoryWisePostypeSRWiseContributionQtn');
echo  $result;
}
...
$result= executeBlock($datezonepostypefilterSession,'DateZonePosTypeWiseSRWiseContributionQtn');
echo  $result;
}
...
$result= executeBlock($datezonecatfilterSession,'DateZoneCategoryWiseSRWiseContributionQtn');
echo  $result;
}
...
$result= executeBlock($datezonefilterSession,'DateWiseZoneWiseSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($datecatSRpromoPostypefilterSession,'DateWiseCategoryWisePromoPostypeSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($datecatSRpromofilterSession,'DateWiseCategoryWisePromoSRWiseContributionQtn');
echo  $result;
}
else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam){ // DONE
  //echo "<pre>"; print_r($_SESSION);die;

$result= executeBlock($datecatSRPostypefilterSession,'DateCategoryPosTypeWiseSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($datecatSRfilterSession,'DateWiseCategoryWiseSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($datecatpromoPostypefilterSession,'DateWiseCategoryWisePromoPostypeSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($datecatPostypefilterSession,'DateCategoryPosTypeWiseSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($datecatpromofilterSession,'DatePromoCategoryWiseSRWiseContributionQtn');
echo  $result;
}
...
$result= executeBlock($datecatfilterSession,'DateWiseCategoryWiseSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($dateempPostypefilterSession,'DateWisePosTypeWiseSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($dateposfilterSession,'DateWisePosTypeWiseSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($dateempfilterSession,'DateWiseSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($datefilter,'DateWiseSRWiseContributionQtn');
echo  $result;
}
...
$result= executeBlock($Empfilter,'SalesPersonWiseContributionQuantity');
echo  $result;
...
$result= executeBlock($YesNoparamfilter,'CustomerDetailsWiseSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($SubCatparamfilter,'SubCategoryWiseSRWiseContributionQtn');
echo  $result;
...
$result= executeBlock($itemcodeparamfilter,'TopTensellingWiseSalespersonWiseContributionQtn');
echo  $result;
