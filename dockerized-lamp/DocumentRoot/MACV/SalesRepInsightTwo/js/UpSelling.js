...
var msg = document.getElementById("DESTROY").value;
   ...
   // .range(["#DA1F27","#9A2282","#DE1A75","#223D95","#1B879B","#1CAC4C","#F18122"]);
	.range(["#DA1F27","#9A2282","#DE1A75","#DFF5F7","#1B879B","#1CAC4C","#F18122","#1E90FF"]);

      var color = function(d) { return d.children ? color1(d["Group"]) : null; }
...
//var Cvalue=encodeURI("http://13.228.26.230/MACV/SalesRepInsightTwo/data/SalesPersonWiseUpSellingQtn.php");
...
if (zone === undefined && state === undefined && city === undefined  && Semp === undefined && SSite === undefined  && Scate === undefined && prname === undefined && startDate === undefined && endDate === undefined && yesno===undefined && subcat===undefined && itemcode===undefined && POSType===undefined)
   {
      links=encodeURI(Cvalue+"?param="+msg);
    ...
    {
      links=encodeURI(Cvalue+"?zoneparam="+zone);
    }
    ...
    {
       links=encodeURI(Cvalue+"?Stateparam="+state);
    ...
    {
        links=encodeURI(Cvalue+"?Cityparam="+city);
       // console.log("ddddddddddd",links);
    }
    ...
    {
        links=encodeURI(Cvalue+"?EmpIdparam="+Semp);
    }
   ...
   {
      links=encodeURI(Cvalue+"?Siteparam="+SSite);
     // console.log("ddddddddddd",links);
   }
  ...
  {
  links=encodeURI(Cvalue+"?categoryparam="+Scate);
 ...
 // console.log("ddddddddddd",links);
  ...
  {
  links=encodeURI(Cvalue+"?YesNoparam="+yesno);
 ...
 // console.log("ddddddddddd",links);
  ...
  {
  links=encodeURI(Cvalue+"?SubCatparam="+subcat);
 ...
 // console.log("ddddddddddd",links);
  ...
  {
  links=encodeURI(Cvalue+"?ProNameparam="+prname);
 ...
 // console.log("ddddddddddd",links);
  ...
  {
  links=encodeURI(Cvalue+"?itemcodeparam="+itemcode);
  ...
  {
  links=encodeURI(Cvalue+"?POSTypeparam="+POSType);
...
function middletext(text) {
  text.attr("x", function(d) { return x(d.x + d.dx / 2); })
    ...
    alert("SR Wise Upselling-Qtn Data is Not Available for Selected Criteria");
  }
    });
 // }
