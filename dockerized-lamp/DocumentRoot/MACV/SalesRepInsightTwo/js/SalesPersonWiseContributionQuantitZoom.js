$( document ).ready(function() {
	   ...
	   SalesPersonWiseContributionQuantityZoom();
});

function SalesPersonWiseContributionQuantityZoom(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,itemcode,POSType)
      {
	...
	var color1 = d3.scale.ordinal()
      ...
      var treemap = d3.layout.treemap()
          ...
          d3.select("#SPWCQZ").html("");
      var div = d3.select("#SPWCQZ").append("div")
          //.attr("id","SalesPWCQ")
    ...
    var groupData = function(groupings, data, key){
      ...
      //var SPWCQ=encodeURI("http://13.228.26.230/MACV/SalesRepInsightTwo/data/SalesPersonWiseContributionQuantity.php"); 
