$( document ).ready(function() {
	   ...
	   SalesPersonWiseContributionValueZoom();
});

function SalesPersonWiseContributionValueZoom(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,itemcode,POSType)
      {
  ...
  //  .range(["#DA1F27","#9A2282","#DE1A75","#223D95","#1B879B","#1CAC4C","#F18122"]);
	...
	.range(["#DA1F27","#9A2282","#DE1A75","#DFF5F7","#1B879B","#1CAC4C","#F18122","#1E90FF"]);
      ...
      var treemap = d3.layout.treemap()
          ...
          d3.select("#SPWCVZ").html("");
      var div = d3.select("#SPWCVZ").append("div")
         // .attr("id","SPWCVZ")
    ...
    var groupData = function(groupings, data, key){
      ...
      //var SPWCV=encodeURI("http://13.228.26.230/MACV/SalesRepInsightTwo/data/SalesPersonWiseContributionValue.php"); 
   ...
   if (startDate === undefined && endDate === undefined && zone===undefined && state===undefined && city === undefined && sourceSite===undefined && promoname===undefined && catgory===undefined && emp===undefined && yesno===undefined && subcat===undefined && itemcode===undefined && POSType===undefined) {
    ...
    {
        links=(SPWCV+"?POSTypeparam="+POSType);
        //console.log("222",links);
    }
        else{
