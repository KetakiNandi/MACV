...
function SalesPersonWiseContributionValue(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,itemcode,POSType)
      {
...
function middletext(text) {
  text.attr("x", function(d) { return x(d.x + d.dx / 2); })
    ...
    alert("SR Wise Contrib-value Data is Not Available for Selected Criteria");
  }
    });
 // }
