$( document ).ready(function() {
	   ...
	   SalesPersonWiseUpsellingQntZoom();
});

function SalesPersonWiseUpsellingQntZoom(startDate,endDate,zone,state,city,SSite,prname,Scate,Semp,yesno,subcat,itemcode,POSType)

      {

       // console.log(startDate,endDate,zone,state,city,SSite,prname,Scate,Semp,yesno,subcat,itemcode);
      var margin = { top: 40, right: 10, bottom:5, left: 70 },
   ...
   // .range(["#DA1F27","#9A2282","#DE1A75","#223D95","#1B879B","#1CAC4C","#F18122"]);
	.range(["#DA1F27","#9A2282","#DE1A75","#DFF5F7","#1B879B","#1CAC4C","#F18122","#1E90FF"]);
      ...
      var treemap = d3.layout.treemap()
          ...
          d3.select("#SRWUQZ").html("");
      var div = d3.select("#SRWUQZ").append("div")
