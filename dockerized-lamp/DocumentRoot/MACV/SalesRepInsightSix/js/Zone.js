...
var endDate;
 ...
 var signal = d3.select('#MacDZ');
	...
	WeekendDayCompared(stDate,endDate,selectedValues,state);
	WeekendComparedZoom(stDate,endDate,selectedValues,state);
	WeekComparedZoom(stDate,endDate,selectedValues,state);
	Macv_WeekDay(stDate,endDate,selectedValues,state);
	SalesPerformanceValueComparedZoom(stDate,endDate,selectedValues,state);
	SalesPerformanceValueCompared(stDate,endDate,selectedValues,state);
	SalesPerformanceQtnComparedZoom(stDate,endDate,selectedValues,state);
	SalesPerformanceQtnCompared(stDate,endDate,selectedValues,state);
