$( document ).ready(function() {
    ...
    SalesPerformanceQtnCompared();
});

function SalesPerformanceQtnCompared(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,POSType){
...
var svg = d3.select("#SPQCom").append("svg")
     .attr("id","SPQComR")
...
var link1;
	...
	//var SPQCom1=encodeURI("http://localhost/MACV/SalesRepInsightFour/data/SalesPerformanceQtn18.php"); 
	//var SPQCom11=encodeURI("http://localhost/MACV/SalesRepInsightFour/data/SalesPerformanceQtn.php"); 
...
if (startDate === undefined && endDate === undefined && zone === undefined && state === undefined && city === undefined && sourceSite === undefined && promoname=== undefined && 
    catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined){
          ...
          links=encodeURI(SPQCom1+"?param="+msg);

          link1=encodeURI(SPQCom11+"?param="+msg);
        }
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCom1+"?zoneparam="+zone);

      link1=encodeURI(SPQCom11+"?zoneparam="+zone);

      console.log("zone",links);
      console.log("zone1",link1);

      d3.select("#SPQComR").remove();
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCom1+"?Stateparam="+state);
      link1=encodeURI(SPQCom11+"?Stateparam="+state);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCom1+"?Cityparam="+city);
      link1=encodeURI(SPQCom11+"?Cityparam="+city);
   ...
   d3.select("#SPQComR").remove();
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCom1+"?Siteparam="+sourceSite);
      link1=encodeURI(SPQCom11+"?Siteparam="+sourceSite);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCom1+"?ProNameparam="+promoname);
      link1=encodeURI(SPQCom11+"?ProNameparam="+promoname);
      ...
      catgory && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCom1+"?categoryparam="+catgory);
      link1=encodeURI(SPQCom11+"?categoryparam="+catgory);
      ...
      catgory=== undefined && emp && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCom1+"?EmpIdparam="+emp);
      link1=encodeURI(SPQCom11+"?EmpIdparam="+emp);
      ...
      catgory=== undefined && emp=== undefined && yesno && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCom1+"?YesNoparam="+yesno);
      link1=encodeURI(SPQCom11+"?YesNoparam="+yesno);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCom1+"?SubCatparam="+subcat);
      link1=encodeURI(SPQCom11+"?SubCatparam="+subcat);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType)
    {
      ...
      links=encodeURI(SPQCom1+"?POSTypeparam="+POSType);
      link1=encodeURI(SPQCom11+"?POSTypeparam="+POSType);

      console.log("17",links);
      console.log("18",link1);
    ...
    {
       links=encodeURI(SPQCom1+"?startDate="+startDate+"&endDate="+endDate);
      links1=encodeURI(SPQCom11+"?startDate="+startDate+"&endDate="+endDate);
        d3.select("#SPQComR").remove();
