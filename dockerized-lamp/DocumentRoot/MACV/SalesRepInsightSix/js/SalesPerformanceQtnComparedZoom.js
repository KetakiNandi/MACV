$( document ).ready(function() {
    ...
    SalesPerformanceQtnComparedZoom();
});

function SalesPerformanceQtnComparedZoom(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,POSType){
...
var svg = d3.select("#SPQCZoom").append("svg")
     .attr("id","SPQCZoomR")
...
var link1;
	...
	//var SPQCZoom1=encodeURI("http://localhost/MACV/SalesRepInsightFour/data/SalesPerformanceQtn18.php"); 
	//var SPQCZoom11=encodeURI("http://localhost/MACV/SalesRepInsightFour/data/SalesPerformanceQtn.php"); 
...
if (startDate === undefined && endDate === undefined && zone === undefined && state === undefined && city === undefined && sourceSite === undefined && promoname=== undefined && 
    catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined){
          ...
          links=encodeURI(SPQCZoom1+"?param="+msg);

          link1=encodeURI(SPQCZoom11+"?param="+msg);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCZoom1+"?zoneparam="+zone);

      link1=encodeURI(SPQCZoom11+"?zoneparam="+zone);

      //console.log("zone",links);
      //console.log("zone1",link1);

      d3.select("#SPQCZoomR").remove();
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCZoom1+"?Stateparam="+state);
      link1=encodeURI(SPQCZoom11+"?Stateparam="+state);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCZoom1+"?Cityparam="+city);
      link1=encodeURI(SPQCZoom11+"?Cityparam="+city);
   ...
   d3.select("#SPQCZoomR").remove();
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCZoom1+"?Siteparam="+sourceSite);
      link1=encodeURI(SPQCZoom11+"?Siteparam="+sourceSite);
	d3.select("#SPQCZoomR").remove();
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCZoom1+"?ProNameparam="+promoname);
      link1=encodeURI(SPQCZoom11+"?ProNameparam="+promoname);
      ...
      catgory && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCZoom1+"?categoryparam="+catgory);
      link1=encodeURI(SPQCZoom11+"?categoryparam="+catgory);
      ...
      catgory=== undefined && emp && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCZoom1+"?EmpIdparam="+emp);
      link1=encodeURI(SPQCZoom11+"?EmpIdparam="+emp);
      ...
      catgory=== undefined && emp=== undefined && yesno && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCZoom1+"?YesNoparam="+yesno);
      link1=encodeURI(SPQCZoom11+"?YesNoparam="+yesno);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat && POSType=== undefined)
    {
      ...
      links=encodeURI(SPQCZoom1+"?SubCatparam="+subcat);
      link1=encodeURI(SPQCZoom11+"?SubCatparam="+subcat);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType)
    {
      ...
      links=encodeURI(SPQCZoom1+"?POSTypeparam="+POSType);
      link1=encodeURI(SPQCZoom11+"?POSTypeparam="+POSType);
    ...
    {
       links=encodeURI(SPQCZoom1+"?startDate="+startDate+"&endDate="+endDate);
      links1=encodeURI(SPQCZoom11+"?startDate="+startDate+"&endDate="+endDate);
        d3.select("#SPQCZoomR").remove();
...
if(data1.length == 0 && data2.length >= 1) {
 ...
 // console.log("ddddddddddd",dataset)
...
bar
    .on("mousemove", function(d){
        ...
        divTooltip.html("Month"+" : "+(d.label)+"<br>"+elementData.name+"<br>"+"Quantity"+" : "+commaFormat(elementData.value));
    });
bar
