$( document ).ready(function() {
    ...
    SalesPerformanceValueComparedZoom();
});

function SalesPerformanceValueComparedZoom(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,POSType){
...
var svg = d3.select("#SPVCZoom").append("svg")
     .attr("id","SPVCZoomR")
...
var link1;
	...
	// var SPVCzoom1=encodeURI("http://localhost/MACV/SalesRepInsightFour/data/SalesPerformanceValue18.php"); 
	// var SPVCzoom11=encodeURI("http://localhost/MACV/SalesRepInsightFour/data/SalesPerformanceValue.php"); 
...
if (startDate === undefined && endDate === undefined && zone === undefined && state === undefined && city === undefined && sourceSite === undefined && promoname=== undefined && 
    catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined){
          ...
          links=encodeURI(SPVCzoom1+"?param="+msg);

          link1=encodeURI(SPVCzoom11+"?param="+msg);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPVCzoom1+"?zoneparam="+zone);

      link1=encodeURI(SPVCzoom11+"?zoneparam="+zone);

    //  console.log("zone",links);
    //  console.log("zone1",link1);

      d3.select("#SPVCZoomR").remove();
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPVCzoom1+"?Stateparam="+state);
      link1=encodeURI(SPVCzoom11+"?Stateparam="+state);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPVCzoom1+"?Cityparam="+city);
      link1=encodeURI(SPVCzoom11+"?Cityparam="+city);
   ...
   d3.select("#SPVCZoomR").remove();
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPVCzoom1+"?Siteparam="+sourceSite);
      link1=encodeURI(SPVCzoom11+"?Siteparam="+sourceSite);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPVCzoom1+"?ProNameparam="+promoname);
      link1=encodeURI(SPVCzoom11+"?ProNameparam="+promoname);
      ...
      catgory && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPVCzoom1+"?categoryparam="+catgory);
      link1=encodeURI(SPVCzoom11+"?categoryparam="+catgory);
      ...
      catgory=== undefined && emp && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPVCzoom1+"?EmpIdparam="+emp);
      link1=encodeURI(SPVCzoom11+"?EmpIdparam="+emp);
      ...
      catgory=== undefined && emp=== undefined && yesno && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=encodeURI(SPVCzoom1+"?YesNoparam="+yesno);
      link1=encodeURI(SPVCzoom11+"?YesNoparam="+yesno);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat && POSType=== undefined)
    {
      ...
      links=encodeURI(SPVCzoom1+"?SubCatparam="+subcat);
      link1=encodeURI(SPVCzoom11+"?SubCatparam="+subcat);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType)
    {
      ...
      links=encodeURI(SPVCzoom1+"?POSTypeparam="+POSType);
      link1=encodeURI(SPVCzoom11+"?POSTypeparam="+POSType);
    ...
    {
       links=encodeURI(SPVCzoom1+"?startDate="+startDate+"&endDate="+endDate);
      links1=encodeURI(SPVCzoom11+"?startDate="+startDate+"&endDate="+endDate);
        d3.select("#SPVCZoomR").remove();

    } 

  //links=(SPVCzoom1+"?POSTypeparam=");
  //link1=(SPVCzoom11+"?POSTypeparam=");
...
bar
    .on("mousemove", function(d){
        ...
        divTooltip.html(" Month"+" : "+(d.label)+"<br>"+elementData.name+"<br>"+"Amounts"+" : "+commaFormat(elementData.value));
    });
bar
