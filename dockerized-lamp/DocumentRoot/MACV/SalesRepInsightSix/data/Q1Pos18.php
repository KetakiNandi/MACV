...
$_SESSION['stDate1'] =  "01-Jan-18";
  
$_SESSION['endDate1']= "31-Mar-18";
...
if ($Sitename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam && $categoryname){ //
  ...
  $result = executeBlock( $datessitecatpromofilterSession , 'DateWiseSourceSiteWiseCategoryWisePromoWiseWeekDaySalesMonth');
  echo $result;
...
//end City
  ...
  $result = executeBlock( $datestateSRPostypefilterSession , 'DateWiseStateWiseSRWisePosTypeWiseWeekDaySalesMonth');
  echo $result;
}
...
//=================end State
  ...
  $result = executeBlock( $datezonecatSRfilterSession , 'DateWiseZoneWiseCategoryWiseSRWiseWeekDaySalesMonth');
  echo $result;
}
