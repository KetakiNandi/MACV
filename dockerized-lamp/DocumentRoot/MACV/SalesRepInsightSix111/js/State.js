...
var signal = d3.select('#MacDS');
    ...
    d3.select('#someButton1')
      .on('click', function(d) {
		...
		WeekendDayCompared(stDate,endDate,zone,selectedValues);
		WeekendComparedZoom(stDate,endDate,zone,selectedValues);
		WeekComparedZoom(stDate,endDate,zone,selectedValues);
		Macv_WeekDay(stDate,endDate,zone,selectedValues);
		SalesPerformanceValueComparedZoom(stDate,endDate,zone,selectedValues);
		SalesPerformanceValueCompared(stDate,endDate,zone,selectedValues);
		SalesPerformanceQtnComparedZoom(stDate,endDate,zone,selectedValues);
		SalesPerformanceQtnCompared(stDate,endDate,zone,selectedValues);
