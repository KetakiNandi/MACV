 ...
 var signal = d3.select('#MacDPN');
    ...
    d3.select('#someButton4')
      .on('click', function(d) {
		...
		WeekendDayCompared(stDate,endDate,zone,state,city,selectedValues);
		WeekendComparedZoom(stDate,endDate,zone,state,city,selectedValues);
		WeekComparedZoom(stDate,endDate,zone,state,city,selectedValues);
		Macv_WeekDay(stDate,endDate,zone,state,city,selectedValues);
		SalesPerformanceValueComparedZoom(stDate,endDate,zone,state,city,selectedValues);
		SalesPerformanceValueCompared(stDate,endDate,zone,state,city,selectedValues);
		SalesPerformanceQtnComparedZoom(stDate,endDate,zone,state,city,selectedValues);
		SalesPerformanceQtnCompared(stDate,endDate,zone,state,city,selectedValues);
