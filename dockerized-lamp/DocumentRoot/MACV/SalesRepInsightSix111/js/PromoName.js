...
function Macv_Promoname(spzone,Sstate,scity,Semp,SSite,Scate,subcat,itemcode,POSType,startDate,endDate){
  ...
  //console.log(spzone,Sstate,scity,Semp,SSite,Scate,subcat,itemcode);
     ...
     // var pName=encodeURI("http://13.228.26.230/MACV/SalesRepInsightTwo/data/promoName.php");
...
var signal = d3.select('#MacDPRN');
	 ...
	 if(sessionFlag==1)
	{
		...
		WeekendDayCompared(stDate,endDate,zone,state,city,SourceSite,selectedValues);
		WeekendComparedZoom(stDate,endDate,zone,state,city,SourceSite,selectedValues);
		WeekComparedZoom(stDate,endDate,zone,state,city,SourceSite,selectedValues);
		Macv_WeekDay(stDate,endDate,zone,state,city,SourceSite,selectedValues);
		SalesPerformanceValueComparedZoom(stDate,endDate,zone,state,city,SourceSite,selectedValues);
		SalesPerformanceValueCompared(stDate,endDate,zone,state,city,SourceSite,selectedValues);
		SalesPerformanceQtnComparedZoom(stDate,endDate,zone,state,city,SourceSite,selectedValues);
		SalesPerformanceQtnCompared(stDate,endDate,zone,state,city,SourceSite,selectedValues);
