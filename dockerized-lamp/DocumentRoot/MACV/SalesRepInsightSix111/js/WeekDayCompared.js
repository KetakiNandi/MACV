...
function Macv_WeekDay(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,POSType){


  //console.log("ddddddddd",startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,POSType)
...
var svg = d3.select("#WeekDayCom").append("svg")
     .attr("id","WeekDayComR")
...
//var WkDCUri1=encodeURI("http://localhost/MACV/SalesRepInsightThree/data/Q1Pos18.php"); 

//var WkDCUri11=encodeURI("http://localhost/MACV/SalesRepInsightThree/data/WeekDayMonth.php"); 
...
if (startDate === undefined && endDate === undefined && zone === undefined && state === undefined && city === undefined && sourceSite === undefined && promoname=== undefined && 
    catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined){
          ...
          links=(WkDCUri1+"?param="+msg);

          link1=(WkDCUri11+"?param="+msg);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=(WkDCUri1+"?zoneparam="+zone);

      link1=(WkDCUri11+"?zoneparam="+zone);

     // console.log("zone",links);
      //console.log("zone1",link1);

      d3.select("#WeekDayComR").remove();
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=(WkDCUri1+"?Stateparam="+state);
      link1=(WkDCUri11+"?Stateparam="+state);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=(WkDCUri1+"?Cityparam="+city);
      link1=(WkDCUri11+"?Cityparam="+city);
   ...
   d3.select("#WeekDayComR").remove();
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=(WkDCUri1+"?Siteparam="+sourceSite);
      link1=(WkDCUri11+"?Siteparam="+sourceSite);
         d3.select("#WeekDayComR").remove();
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=(WkDCUri1+"?ProNameparam="+promoname);
      link1=(WkDCUri11+"?ProNameparam="+promoname);
      ...
      catgory && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=(WkDCUri1+"?categoryparam="+catgory);
      link1=(WkDCUri11+"?categoryparam="+catgory);
      ...
      catgory=== undefined && emp && yesno=== undefined && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=(WkDCUri1+"?EmpIdparam="+emp);
      link1=(WkDCUri11+"?EmpIdparam="+emp);
      ...
      catgory=== undefined && emp=== undefined && yesno && subcat=== undefined && POSType=== undefined)
    {
      ...
      links=(WkDCUri1+"?YesNoparam="+yesno);
      link1=(WkDCUri11+"?YesNoparam="+yesno);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat && POSType=== undefined)
    {
      ...
      links=(WkDCUri1+"?SubCatparam="+subcat);
      link1=(WkDCUri11+"?SubCatparam="+subcat);
      ...
      catgory=== undefined && emp=== undefined && yesno=== undefined && subcat=== undefined && POSType)
    {
      ...
      links=(WkDCUri1+"?POSTypeparam="+POSType);
      link1=(WkDCUri11+"?POSTypeparam="+POSType);
    ...
    {
       links=encodeURI(WkDCUri1+"?startDate="+startDate+"&endDate="+endDate);
      links1=encodeURI(WkDCUri11+"?startDate="+startDate+"&endDate="+endDate);
        d3.select("#WeekDayComR").remove();
