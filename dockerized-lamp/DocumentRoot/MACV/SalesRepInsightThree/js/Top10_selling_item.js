...
function PoSperformance(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,POSType)
      {
...
var links;
      //var ToptenSell=encodeURI("http://13.228.26.230/MACV/SalesRepInsightThree/data/Top10SellingItem.php"); 
    ...
    .enter().append("div")
      ...
      .on("click", function(d){
        //console.log(d["demographics"]["Group"]);
         ...
         // Macv_POSType(zone,state,city,emp,SourceSite,catgory,promo,subcat,d["demographics"]["Group"]);
