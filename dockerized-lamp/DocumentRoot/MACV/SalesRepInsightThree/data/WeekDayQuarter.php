...
if ($Sitename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam && $categoryname){ //
  $result = executeBlock( $datessitecatSRPostypefilterSession , 'DateSourceSiteWiseCategoryWiseSRWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;

}
else if ($Sitename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //
  $result = executeBlock( $datessitecatSRfilterSession , 'DateSourceSiteWiseCategoryWiseSRWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;

}
else if ($Sitename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam){ //
  $result = executeBlock( $datessiteSRPostypefilterSession , 'DateWiseSourceSiteWiseSRWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;

}
else if ($Sitename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //
  $result = executeBlock( $datessiteSRfilterSession , 'DateWiseSourceSiteWiseSRWiseWeekDaySalesQuarter');
  echo $result; 

}
else if ($Sitename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam && $Promoname){ //
  $result = executeBlock( $datessitecatpromoPostypefilterSession , 'DateWiseSourceSiteWiseCategoryWisePosTypeWisePromoWiseWeekDaySalesQuarter');
  echo $result;

}
else if ($Sitename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam){ //
  $result = executeBlock( $datessitecatPostypefilterSession , 'DateWiseSourceSiteWiseCategoryWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($Sitename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $Promoname){ //
  $result = executeBlock( $datessitecatpromofilterSession , 'DateWiseSourceSiteWiseCategoryWisePromoWiseWeekDaySalesQuarter');
  echo $result;

}
else if ($Sitename && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate']){ //
  $result = executeBlock( $datessitepostypefilterSession , 'DateWiseSourceSiteWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;

}
else if ($Sitename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate']){ //
  $result = executeBlock( $datessitecatfilterSession , 'DateWiseSourceSiteWiseCategoryWiseWeekDaySalesQuarter');
  echo $result;

}
else if ($Sitename && $_SESSION['stDate'] && $_SESSION['endDate']){ //
  $result = executeBlock( $datessitefilterSession , 'DateWiseSourceSiteWiseWeekDaySalesQuarter');
  echo $result;
...
//end sourceSite
  ...
  $result = executeBlock( $datecitycatSRPostypefilterSession , 'DateCityWiseCategoryWiseSRWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($Cityname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam){ //done
  $result = executeBlock( $datecitySRPostypefilterSession , 'DateWiseCityWiseSRWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;
}

else if ($Cityname && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //
  $result = executeBlock( $datecitycatSRfilterSession , 'DateWiseCityWiseCategoryWiseSRWiseWeekDaySalesQuarter');
  echo $result;
}

else if ($Cityname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //done
  $result = executeBlock( $datecitySRfilterSession , 'DateWiseCityWiseSRWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($Cityname && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $Promoname && $POSTypeparam){ //
  $result = executeBlock( $datecitycatpromoPostypefilterSession , 'DateWiseCityWiseCategoryWisePosTypeWisePromoWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($Cityname && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $Promoname){ //done
  $result = executeBlock( $datecitycatpromofilterSession , 'DateWiseCityWiseCategoryWisePromoWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($Cityname && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname){ //
  $result = executeBlock( $datecitycatPostypefilterSession , 'DateWiseCityWiseCategoryWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($Cityname && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate']){ //
  $result = executeBlock( $datecitypostypefilterSession , 'DateWiseCityWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($Cityname && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate']){ //done
  $result = executeBlock( $datecitycatfilterSession , 'DateWiseCityWiseCategoryWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($Cityname && $_SESSION['stDate'] && $_SESSION['endDate']){ //done
  $result = executeBlock( $datecityfilterSession , 'DateWiseCityWiseWeekDaySalesQuarter');
  echo $result;

}
//end City
else if ($statename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam && $categoryname){ //done
  $result = executeBlock( $datestatecatSRPostypefilterSession , 'DateStateWiseCategoryWiseSRWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($statename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //done
  $result = executeBlock( $datestatecatSRfilterSession , 'DateWiseStateWiseCategoryWiseSRWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($statename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam){ //Done
  $result = executeBlock( $datestateSRPostypefilterSession , 'DateWiseSRWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($statename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //done
  $result = executeBlock( $datestateSRfilterSession , 'DateWiseStateWiseSRWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($statename && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $Promoname){ //done
  $result = executeBlock( $datestatecatpromoPostypefilterSession , 'DateWiseStateWiseCategoryWisePosTypeWisePromoWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($statename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $Promoname){ //done
  $result = executeBlock( $datestatecatpromofilterSession , 'DateWiseStateWiseCategoryWisePromoWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($statename && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname){ //done
  $result = executeBlock( $datestatecatPostypefilterSession , 'DateWiseStateWiseCategoryWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($statename && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate']){ //Done
  $result = executeBlock( $datestatepostypefilterSession , 'DateWiseStateWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($statename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate']){ //done
  $result = executeBlock( $datestatecatfilterSession , 'DateWiseStateWiseCategoryWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($statename && $_SESSION['stDate'] && $_SESSION['endDate']){ //done
  $result = executeBlock( $datestatefilterSession , 'DateWiseStateWiseWeekDaySalesQuarter');
  echo $result;
...
//=================end State
  ...
  $result = executeBlock( $datezonecatSRPostypefilterSession , 'DateZoneWiseCategoryWiseSRWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($zonename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //done
  $result = executeBlock( $datezonecatSRfilterSession , 'DateWiseZoneWiseCategoryWiseSRWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($zonename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam){ //done
  $result = executeBlock( $datezoneSRPostypefilterSession , 'DateWiseZoneWiseSRWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($zonename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //done
  $result = executeBlock( $datezoneSRfilterSession , 'DateWiseZoneWiseSRWiseWeekDaySalesQuarter');
  echo $result;
  
}
else if ($zonename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam && $Promoname){ //Done
  $result = executeBlock( $datezonecatpromoPostypefilterSession , 'DateWiseZoneWiseCategoryWisePosTypeWisePromoWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($zonename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $Promoname){//done
  $result = executeBlock( $datezonecatpromofilterSession , 'DateWiseZoneWiseCategoryWisePromoWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($zonename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam){ //done
  $result = executeBlock( $datezonecatPostypefilterSession , 'DateWiseZoneWiseCategoryWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($zonename && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate']){ //done
  $result = executeBlock( $datezonepostypefilterSession , 'DateWiseZoneWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($zonename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate']){ //done
  $result = executeBlock( $datezonecatfilterSession , 'DateWiseZoneWiseCategoryWiseWeekDaySalesQuarter');
  echo $result;
}
else if ($zonename && $_SESSION['stDate'] && $_SESSION['endDate']){ //Done
  $result = executeBlock( $datezonefilterSession , 'DateWiseZoneWiseWeekDaySalesQuarter');
  echo $result;

}
//================================Zone end ======================================
else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $Promoname && $POSTypeparam){ //
  $result = executeBlock( $datecatSRpromoPostypefilterSession , 'DateWiseSRWiseCategoryWisePosTypeWisePromoWiseWeekDaySalesQuarter');
  echo $result;

}
else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $Promoname){ //
  $result = executeBlock( $datecatSRpromofilterSession , 'DateWiseSRWiseCategoryWisePromoWiseWeekDaySalesQuarter');
  echo $result;

}
else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam){ //
  $result = executeBlock( $datecatSRPostypefilterSession , 'DateWiseSRWiseCategoryWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;

}
else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //
  $result = executeBlock( $datecatSRfilterSession , 'DateWiseSRWiseCategoryWiseWeekDaySalesQuarter');
  echo $result;

}
else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam && $Promoname){ //
  $result = executeBlock( $datecatpromoPostypefilterSession , 'DateWiseCategoryWisePromoWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;

}
else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam){ //
  $result = executeBlock( $datecatPostypefilterSession , 'DateWiseCategoryWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;

}
else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $Promoname){ //
  $result = executeBlock( $datecatpromofilterSession , 'DateWiseCategoryWisePromoWeekDaySalesQuarter');
  echo $result;

}

else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate']){ // *************************************
  $result = executeBlock( $datecatfilterSession , 'DateWiseCategoryWiseWeekDaySalesQuarter');
  echo $result;

}
else if ($EmpIdname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam){ //
  $result = executeBlock( $dateempPostypefilterSession , 'DateWiseSRWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;

}
else if ($POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate']){ // **************************************************
  $result = executeBlock( $dateposfilterSession , 'DateWisePosTypeWiseWeekDaySalesQuarter');
  echo $result;

}
else if ($EmpIdname && $_SESSION['stDate'] && $_SESSION['endDate']){ //
  $result = executeBlock( $dateempfilterSession , 'DateWiseSRWiseWeekDaySalesQuarter');
  echo $result;
  ...
  $result = executeBlock( $datefilter , 'WeekDaySalesQuarter');
  echo $result; 
  }
else
{
