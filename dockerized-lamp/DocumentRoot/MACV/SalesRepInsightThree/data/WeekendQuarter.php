...
if ($Sitename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam && $categoryname){ //
  $result = executeBlock( $datessitecatSRPostypefilterSession , 'DateSourceSiteWiseCategoryWiseSRWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;

}
else if ($Sitename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //
  $result = executeBlock( $datessitecatSRfilterSession , 'DateSourceSiteWiseCategoryWiseSRWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;

}
else if ($Sitename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam){ //
  $result = executeBlock( $datessiteSRPostypefilterSession , 'DateWiseSourceSiteWiseSRWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;

}
else if ($Sitename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //
  $result = executeBlock( $datessiteSRfilterSession , 'DateWiseSourceSiteWiseSRWiseWeekendSalesMonthQuarter');
  echo $result; 

}
else if ($Sitename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam && $Promoname){ //
  $result = executeBlock( $datessitecatpromoPostypefilterSession , 'DateWiseSourceSiteWiseCategoryWisePosTypeWisePromoWiseWeekendSalesMonthQuarter');
  echo $result;

}
else if ($Sitename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam){ //
  $result = executeBlock( $datessitecatPostypefilterSession , 'DateWiseSourceSiteWiseCategoryWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($Sitename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $Promoname){ //
  $result = executeBlock( $datessitecatpromofilterSession , 'DateWiseSourceSiteWiseCategoryWisePromoWiseWeekendSalesMonthQuarter');
  echo $result;

}
else if ($Sitename && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate']){ //
  $result = executeBlock( $datessitepostypefilterSession , 'DateWiseSourceSiteWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;

}
else if ($Sitename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate']){ //
  $result = executeBlock( $datessitecatfilterSession , 'DateWiseSourceSiteWiseCategoryWiseWeekendSalesMonthQuarter');
  echo $result;

}
else if ($Sitename && $_SESSION['stDate'] && $_SESSION['endDate']){ //
  $result = executeBlock( $datessitefilterSession , 'DateWiseSourceSiteWiseWeekendSalesMonthQuarter');
  echo $result;
...
//end sourceSite
  ...
  $result = executeBlock( $datecitycatSRPostypefilterSession , 'DateCityWiseCategoryWiseSRWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($Cityname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam){ //done
  $result = executeBlock( $datecitySRPostypefilterSession , 'DateWiseCityWiseSRWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;
}

else if ($Cityname && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //
  $result = executeBlock( $datecitycatSRfilterSession , 'DateWiseCityWiseCategoryWiseSRWiseWeekendSalesMonthQuarter');
  echo $result;
}

else if ($Cityname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //done
  $result = executeBlock( $datecitySRfilterSession , 'DateWiseCityWiseSRWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($Cityname && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $Promoname && $POSTypeparam){ //
  $result = executeBlock( $datecitycatpromoPostypefilterSession , 'DateWiseCityWiseCategoryWisePosTypeWisePromoWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($Cityname && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $Promoname){ //done
  $result = executeBlock( $datecitycatpromofilterSession , 'DateWiseCityWiseCategoryWisePromoWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($Cityname && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname){ //
  $result = executeBlock( $datecitycatPostypefilterSession , 'DateWiseCityWiseCategoryWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($Cityname && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate']){ //
  $result = executeBlock( $datecitypostypefilterSession , 'DateWiseCityWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($Cityname && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate']){ //done
  $result = executeBlock( $datecitycatfilterSession , 'DateWiseCityWiseCategoryWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($Cityname && $_SESSION['stDate'] && $_SESSION['endDate']){ //done
  $result = executeBlock( $datecityfilterSession , 'DateWiseCityWiseWeekendSalesMonthQuarter');
  echo $result;

}
//end City
else if ($statename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam && $categoryname){ //done
  $result = executeBlock( $datestatecatSRPostypefilterSession , 'DateStateWiseCategoryWiseSRWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($statename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //done
  $result = executeBlock( $datestatecatSRfilterSession , 'DateWiseStateWiseCategoryWiseSRWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($statename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam){ //Done
  $result = executeBlock( $datestateSRPostypefilterSession , 'DateWiseStateWiseSRWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($statename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //done
  $result = executeBlock( $datestateSRfilterSession , 'DateWiseStateWiseSRWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($statename && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname && $Promoname){ //done
  $result = executeBlock( $datestatecatpromoPostypefilterSession , 'DateWiseStateWiseCategoryWisePosTypeWisePromoWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($statename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $Promoname){ //done
  $result = executeBlock( $datestatecatpromofilterSession , 'DateWiseStateWiseCategoryWisePromoWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($statename && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate'] && $categoryname){ //done
  $result = executeBlock( $datestatecatPostypefilterSession , 'DateWiseStateWiseCategoryWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($statename && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate']){ //Done
  $result = executeBlock( $datestatepostypefilterSession , 'DateWiseStateWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($statename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate']){ //done
  $result = executeBlock( $datestatecatfilterSession , 'DateWiseStateWiseCategoryWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($statename && $_SESSION['stDate'] && $_SESSION['endDate']){ //done
  $result = executeBlock( $datestatefilterSession , 'DateWiseStateWiseWeekendSalesMonthQuarter');
  echo $result;
...
//=================end State
  ...
  $result = executeBlock( $datezonecatSRPostypefilterSession , 'DateZoneWiseCategoryWiseSRWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($zonename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //done
  $result = executeBlock( $datezonecatSRfilterSession , 'DateWiseZoneWiseCategoryWiseSRWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($zonename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam){ //done
  $result = executeBlock( $datezoneSRPostypefilterSession , 'DateWiseZoneWiseSRWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($zonename && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //done
  $result = executeBlock( $datezoneSRfilterSession , 'DateWiseZoneWiseSRWiseWeekendSalesMonthQuarter');
  echo $result;
  
}
else if ($zonename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam && $Promoname){ //Done
  $result = executeBlock( $datezonecatpromoPostypefilterSession , 'DateWiseZoneWiseCategoryWisePosTypeWisePromoWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($zonename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $Promoname){//done
  $result = executeBlock( $datezonecatpromofilterSession , 'DateWiseZoneWiseCategoryWisePromoWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($zonename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam){ //done
  $result = executeBlock( $datezonecatPostypefilterSession , 'DateWiseZoneWiseCategoryWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($zonename && $POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate']){ //done
  $result = executeBlock( $datezonepostypefilterSession , 'DateWiseZoneWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($zonename && $categoryname && $_SESSION['stDate'] && $_SESSION['endDate']){ //done
  $result = executeBlock( $datezonecatfilterSession , 'DateWiseZoneWiseCategoryWiseWeekendSalesMonthQuarter');
  echo $result;
}
else if ($zonename && $_SESSION['stDate'] && $_SESSION['endDate']){ //Done
  $result = executeBlock( $datezonefilterSession , 'DateWiseZoneWiseWeekendSalesMonthQuarter');
  echo $result;

}
//================================Zone end ======================================
else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $Promoname && $POSTypeparam){ //
  $result = executeBlock( $datecatSRpromoPostypefilterSession , 'DateWiseSRWiseCategoryWisePosTypeWisePromoWiseWeekendSalesMonthQuarter');
  echo $result;

}
else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $Promoname){ //
  $result = executeBlock( $datecatSRpromofilterSession , 'DateWiseSRWiseCategoryWisePromoWiseWeekendSalesMonthQuarter');
  echo $result;

}
else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname && $POSTypeparam){ //
  $result = executeBlock( $datecatSRPostypefilterSession , 'DateWiseSRWiseCategoryWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;

}
else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $EmpIdname){ //
  $result = executeBlock( $datecatSRfilterSession , 'DateWiseSRWiseCategoryWiseWeekendSalesMonthQuarter');
  echo $result;

}
else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam && $Promoname){ //
  $result = executeBlock( $datecatpromoPostypefilterSession , 'DateWiseCategoryWisePromoWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;

}
else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam){ //
  $result = executeBlock( $datecatPostypefilterSession , 'DateWiseCategoryWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;

}
else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate'] && $Promoname){ //
  $result = executeBlock( $datecatpromofilterSession , 'DateWiseCategoryWisePromoWeekendSalesMonthQuarter');
  echo $result;

}

else if ($categoryname && $_SESSION['stDate'] && $_SESSION['endDate']){ // *************************************
  $result = executeBlock( $datecatfilterSession , 'DateWiseCategoryWiseWeekendSalesMonthQuarter');
  echo $result;

}
else if ($EmpIdname && $_SESSION['stDate'] && $_SESSION['endDate'] && $POSTypeparam){ //
  $result = executeBlock( $dateempPostypefilterSession , 'DateWiseSRWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;

}
else if ($POSTypeparam && $_SESSION['stDate'] && $_SESSION['endDate']){ // **************************************************
  $result = executeBlock( $dateposfilterSession , 'DateWisePosTypeWiseWeekendSalesMonthQuarter');
  echo $result;

}
else if ($EmpIdname && $_SESSION['stDate'] && $_SESSION['endDate']){ //
  $result = executeBlock( $dateempfilterSession , 'DateWiseSRWiseWeekendSalesMonthQuarter');
  echo $result;
  ...
  $result = executeBlock( $datefilter , 'WeekendSalesQuarter');
  echo $result; 
  }
else
{
...
function executeBlock($queryVar,$collection){
 ...
 foreach ($rows as $row){
  ...
  if($findCounter==0){
    $data[$i]     =  array("Quarter"=>($row->Quarter),"Quantity"=>($row->Quantity));
  } else {
    $findCounter  = 0;
  }
}
