...
//end City
  ...
  $result = executeBlock( $datestateSRPostypefilterSession , 'DateWiseSRWisePosTypeWiseWeekendSalesMonth');
  echo $result;
}
...
//=================end State
  ...
  $result = executeBlock( $datezonecatSRfilterSession , 'DateWiseSRWiseCategoryWiseWeekendSalesMonth');
  echo $result;
}
