...
object DateWiseSourceSiteWiseCategoryWisePosTypeWisePromoWiseWeekendSalesMonth {
  ...
  def main(args: Array[String]) {
    ...
    val spark = SparkSession.builder()
      ...
      .config("spark.mongodb.input.uri", "mongodb://127.0.0.1/SaleRepInsight.DateWiseSourceSiteWiseCategoryWisePosTypeWisePromoWiseWeekendSalesMonth")
      .config("spark.mongodb.output.uri", "mongodb://127.0.0.1/SaleRepInsight.DateWiseSourceSiteWiseCategoryWisePosTypeWisePromoWiseWeekendSalesMonth")
