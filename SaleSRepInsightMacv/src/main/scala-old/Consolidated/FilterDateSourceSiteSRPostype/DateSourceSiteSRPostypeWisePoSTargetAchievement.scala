package FilterDateSourceSiteSRPostype
...
object DateSourceSiteSRPostypeWisePoSTargetAchievement {
  ...
  = {
    ...
    (Try(fields(1)) getOrElse ("") ,Try(fields(8)) getOrElse (""),Try(fields(9)) getOrElse (""), Try(fields(29)) getOrElse (""),
  ...
  def main(args: Array[String]) {
    ...
    val spark = SparkSession.builder()
      ...
      .config("spark.mongodb.input.uri", "mongodb://127.0.0.1/SaleRepInsight.DateSourceSiteSRPostypeWisePoSTargetAchievement")
      .config("spark.mongodb.output.uri", "mongodb://127.0.0.1/SaleRepInsight.DateSourceSiteSRPostypeWisePoSTargetAchievement")
