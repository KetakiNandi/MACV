...
object SalesperformanceValueQuarterWiseTop10ItemSales {
  ...
  def main(args: Array[String]) {
    ...
    val spark = SparkSession.builder()
      ...
      .config("spark.mongodb.input.uri", "mongodb://127.0.0.1/SaleRepInsight.SalesperformanceValueQuarterWiseTop10ItemSales")
      .config("spark.mongodb.output.uri", "mongodb://127.0.0.1/SaleRepInsight.SalesperformanceValueQuarterWiseTop10ItemSales")
   ...
   val finalResult=DownloaddataCount.map(s=>(s._1.split("@")(0),s._1.split("@")(1),s._1.split("@")(3),s._2))
    ...
    results.foreach({ rdd =>
      ...
      val newDocs = Seq(new Document("TimeStamp",today).append("Item_Code",rdd._2).append("Quarter",rdd._3).append("SubCategory",rdd._1).append("Amount",rdd._4))
