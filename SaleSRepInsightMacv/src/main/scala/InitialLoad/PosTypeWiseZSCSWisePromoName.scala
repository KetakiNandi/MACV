...
object PosTypeWiseZSCSWisePromoName {
  ...
  = {
    ...
    (Try(fields(0)) getOrElse(""),Try(fields(22)) getOrElse(""),Try(fields(21)) getOrElse(""),Try(fields(20)) getOrElse(""),Try(fields(5)) getOrElse(""),Try(fields(11)) getOrElse(""),Try(fields(10)) getOrElse(""))
  ...
  def main(args: Array[String]) {
    ...
    val spark = SparkSession.builder()
      ...
      .config("spark.mongodb.input.uri", "mongodb://127.0.0.1/SaleRepInsight.PosTypeWiseZSCSWisePromoName")
      .config("spark.mongodb.output.uri", "mongodb://127.0.0.1/SaleRepInsight.PosTypeWiseZSCSWisePromoName")
    ...
    val DistinctZoneAndPosCode = TotalFilter.map(s=>(s._1,s._2,s._3,s._4,s._5,s._6,s._7.replace("-",""))).distinct().map(s=>(s._1,s._2+"#"+s._3+"#"+s._4+"#"+s._5+"#"+s._6+"#"+s._7))
    ...
    results.foreach({ rdd =>
      ...
      val newDocs = Seq(new Document("TimeStamp",today).append("Zone",rdd._1).append("State",rdd._2).append("City",rdd._3).append("SourceSite",rdd._4).append("PromoName",rdd._5).append("PromoNo",rdd._6).append("PosType",rdd._7))
