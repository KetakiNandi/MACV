...
object TopTenSellingWiseCustomberDetailsFilled {
  ...
  = {
    ...
    (Try(fields(14)) getOrElse (""),Try(fields(7)) getOrElse (""))
  ...
  def main(args: Array[String]) {
    ...
    val spark = SparkSession.builder()
      ...
      .config("spark.mongodb.input.uri", "mongodb://127.0.0.1/SaleRepInsight.TopTenSellingWiseCustomberDetailsFilled")
      .config("spark.mongodb.output.uri", "mongodb://127.0.0.1/SaleRepInsight.TopTenSellingWiseCustomberDetailsFilled")
    ...
    results.foreach({ rdd =>
      ...
      val newDocs = Seq(new Document("TimeStamp",today).append("Item_Code",rdd._1).append("CustomerMobile",rdd._2).append("Count",rdd._3))
