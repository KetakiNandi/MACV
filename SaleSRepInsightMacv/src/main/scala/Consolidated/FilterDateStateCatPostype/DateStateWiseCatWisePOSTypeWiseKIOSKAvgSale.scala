...
object DateStateWiseCatWisePOSTypeWiseKIOSKAvgSale {
  ...
  = {
    ...
    (Try(fields(0)) getOrElse(""),Try(fields(1)) getOrElse(""),Try(fields(5)) getOrElse(""),Try(fields(21)) getOrElse(""),Try(fields(12)) getOrElse(""),Try(fields(29)) getOrElse(""),Try(fields(18)) getOrElse(0.0))//poscode,date,SSite,amount
  ...
  def main(args: Array[String]) {
    ...
    val spark = SparkSession.builder()
      ...
      .config("spark.mongodb.input.uri", "mongodb://127.0.0.1/SaleRepInsight.DateStateWiseCatWisePOSTypeWiseKIOSKAvgSale")
      .config("spark.mongodb.output.uri", "mongodb://127.0.0.1/SaleRepInsight.DateStateWiseCatWisePOSTypeWiseKIOSKAvgSale")
