...
var SourceSite;
 ...
 var pEmpId=encodeURI("http://localhost/MACV/SalesRepInsightThree/data/empID.php");
...
return "<form><input type=checkbox class=che  id=check ><span><button class=Macd >" + d.EmpName + "</button></span> </form>";
 ...
 .on("click", function(d){
  ...
  PoSperformanceZoom(stDate,endDate,zone,state,city,SourceSite,promo,catgory,d.EmpID);
