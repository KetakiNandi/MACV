...
if ($zonename && $_SESSION['stDate'] && $_SESSION['endDate']){
	...
	$rows  = $mng->executeQuery("SaleRepInsight.DateWiseStateWiseSalesperformanceValue", $query);
	$data                 = array();
  $findCounter          = 0;
  foreach ($rows as $row){
   $milliseconds = $row->date->toDateTime();
  ...
  echo json_encode($data);
	...
	$rows  = $mng->executeQuery("SaleRepInsight.DateWiseCityWiseSalesperformanceValue", $query);
	$data                 = array();
  $findCounter          = 0;
  foreach ($rows as $row){
   $milliseconds = $row->date->toDateTime();
  ...
  echo json_encode($data);
	...
	$rows  = $mng->executeQuery("SaleRepInsight.DateWiseSourceSiteWiseSalesperformanceValue", $query);
	$data                 = array();
  $findCounter          = 0;
  foreach ($rows as $row){
   $milliseconds = $row->date->toDateTime();
  ...
  echo json_encode($data);
	...
	$rows  = $mng->executeQuery("SaleRepInsight.CategoryWiseSalesPerformanceValue", $query);
	$data                 = array();
  $findCounter          = 0;
  foreach ($rows as $row){
   $milliseconds = $row->date->toDateTime();
  ...
  echo json_encode($data);
	...
	$rows  = $mng->executeQuery("SaleRepInsight.PromoNameWiseSalesPerformanceValue", $query);
	$data                 = array();
  $findCounter          = 0;
  foreach ($rows as $row){
   $milliseconds = $row->date->toDateTime();
  ...
  echo json_encode($data);
	...
	$rows  = $mng->executeQuery("SaleRepInsight.SalesRepWiseSalesPerformanceValue", $query);
	$data                 = array();
  $findCounter          = 0;
  foreach ($rows as $row){
   $milliseconds = $row->date->toDateTime();
