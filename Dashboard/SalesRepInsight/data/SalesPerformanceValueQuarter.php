...
if ($zonename && $_SESSION['stDate'] && $_SESSION['endDate']){
	...
	$rows  = $mng->executeQuery("SaleRepInsight.DateWiseZoneWiseQuarterValue", $query);
	$data                 = array();
  $findCounter          = 0;
   foreach($rows as $row){
  ...
  echo json_encode($data);
	...
	$rows  = $mng->executeQuery("SaleRepInsight.DateWiseStateeWiseQuarterValue", $query);
	$data                 = array();
  $findCounter          = 0;
   foreach($rows as $row){
              for($i=0;$i<count($data);$i++){
  ...
  echo json_encode($data);
	...
	$rows  = $mng->executeQuery("SaleRepInsight.DateWiseCityWiseQuarterValue", $query);
	$data                 = array();
  $findCounter          = 0;
   foreach($rows as $row){
              for($i=0;$i<count($data);$i++){
  ...
  echo json_encode($data);
	...
	$rows  = $mng->executeQuery("SaleRepInsight.DateWisePosTypeWiseQuarterValue", $query);
	$data                 = array();
  $findCounter          = 0;
   foreach($rows as $row){
              for($i=0;$i<count($data);$i++){
  ...
  echo json_encode($data);
	...
	$rows  = $mng->executeQuery("SaleRepInsight.DateWiseSourceSiteWiseQuarterValue", $query);
	$data                 = array();
  $findCounter          = 0;
   foreach($rows as $row){
              for($i=0;$i<count($data);$i++){
  ...
  echo json_encode($data);
	...
	$rows  = $mng->executeQuery("SaleRepInsight.DateWiseCategoryWiseQuarterValue", $query);
	$data                 = array();
  $findCounter          = 0;
   foreach($rows as $row){
              for($i=0;$i<count($data);$i++){
  ...
  echo json_encode($data);
	...
	$rows  = $mng->executeQuery("SaleRepInsight.DateWisePromoWiseQuarterValue", $query);
	$data                 = array();
  $findCounter          = 0;
   foreach($rows as $row){
              for($i=0;$i<count($data);$i++){
  ...
  echo json_encode($data);
	...
	$rows  = $mng->executeQuery("SaleRepInsight.DateWiseEmpIdWiseQuarterValue", $query);
	$data                 = array();
  $findCounter          = 0;
   foreach($rows as $row){
              for($i=0;$i<count($data);$i++){
