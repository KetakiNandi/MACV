...
//echo "<pre>" ;print_r($POSTypefilter);
//die;
...
if ($zonename && $_SESSION['stDate'] && $_SESSION['endDate']){
  ...
  echo json_encode($data);
	...
	$rows  = $mng->executeQuery("SaleRepInsight.PosTypeWiseSalesPerformanceValueASP", $query);
	$data                 = array();
  $findCounter          = 0;
  foreach ($rows as $row){
           $milliseconds = $row->date->toDateTime();
  ...
  echo json_encode($data);
	...
	$rows  = $mng->executeQuery("SaleRepInsight.CategoryWiseSalesPerformanceValueASP", $query);
	$data                 = array();
  $findCounter          = 0;
  foreach ($rows as $row){
           $milliseconds = $row->date->toDateTime();
  ...
  echo json_encode($data);
	...
	$rows  = $mng->executeQuery("SaleRepInsight.PromoNameWiseSalesPerformanceValueASP", $query);
	$data                 = array();
  $findCounter          = 0;
  foreach ($rows as $row){
           $milliseconds = $row->date->toDateTime();
  ...
  echo json_encode($data);
	...
	$rows  = $mng->executeQuery("SaleRepInsight.SalesRepWiseSalesPerformanceValueASP", $query);
	$data                 = array();
  $findCounter          = 0;
  foreach ($rows as $row){
           $milliseconds = $row->date->toDateTime();
