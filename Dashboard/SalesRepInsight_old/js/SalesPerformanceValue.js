...
function SalesPerformanceValue(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,itemcode){
  ...
  var links1;
   ...
   var SPV=encodeURI("http://localhost/MACV/SalesRepInsight/data/SalesPerformanceValue.php"); 

   var SPVL=encodeURI("http://localhost/MACV/SalesRepInsight/data/SalesPerformanceValueASP.php"); 
   ...
   if (startDate === undefined && endDate === undefined && zone === undefined && state === undefined && city === undefined && sourceSite===undefined && promoname===undefined && catgory===undefined && emp===undefined && yesno===undefined && subcat===undefined && itemcode===undefined) {
    ...
    else if(startDate === undefined && endDate === undefined && zone === undefined && state && city === undefined && sourceSite===undefined && promoname===undefined && catgory===undefined && emp===undefined && yesno===undefined && subcat===undefined && itemcode===undefined)
    {
    ...
    else if(startDate === undefined && endDate === undefined && zone === undefined && city && state === undefined && sourceSite===undefined && promoname===undefined && catgory===undefined && emp===undefined && yesno===undefined && subcat===undefined && itemcode===undefined)
    {
          links=encodeURI(SPV+"?Cityparam="+city);
          links1=encodeURI(SPVL+"?Cityparam="+city);
          d3.select("#SPVR").remove();
    }
     else if(startDate === undefined && endDate === undefined && zone === undefined && sourceSite && state === undefined && city===undefined && promoname===undefined && catgory===undefined && emp===undefined && yesno===undefined && subcat===undefined && itemcode===undefined)
    {
          links=encodeURI(SPV+"?Siteparam="+sourceSite);
          links1=encodeURI(SPVL+"?Siteparam="+sourceSite);
          d3.select("#SPVR").remove();
    }
    else if(startDate === undefined && endDate === undefined && zone === undefined && promoname && state === undefined && city===undefined && sourceSite===undefined && catgory===undefined && emp===undefined && yesno===undefined && subcat===undefined && itemcode===undefined)
    {
    ...
    else if(startDate === undefined && endDate === undefined && zone === undefined && catgory && state === undefined && city===undefined && sourceSite===undefined && promoname===undefined && emp===undefined && yesno===undefined && subcat===undefined && itemcode===undefined)
    {
    ...
    else if(startDate === undefined && endDate === undefined && zone === undefined && emp && state === undefined && city===undefined && sourceSite===undefined && promoname===undefined && catgory===undefined && yesno===undefined && subcat===undefined && itemcode===undefined)
    {
    ...
    else if(startDate === undefined && endDate === undefined && zone === undefined && yesno && state === undefined && city===undefined && sourceSite===undefined && promoname===undefined && catgory===undefined && emp===undefined && subcat===undefined && itemcode===undefined)
    {
    ...
    else if(startDate === undefined && endDate === undefined && zone === undefined && subcat && state === undefined && city===undefined && sourceSite===undefined && promoname===undefined && catgory===undefined && emp===undefined && yesno===undefined && itemcode===undefined)
    {
    ...
    else if(startDate === undefined && endDate === undefined && zone === undefined && itemcode && state === undefined && city===undefined && sourceSite===undefined && promoname===undefined && catgory===undefined && emp===undefined && yesno===undefined && subcat===undefined)
    {
      ...
      .on("click", function(d){
        ...
        SalesPersonWiseUpsellingQnt(datefmt(firstDay),datefmt(lastDay));
         ...
         if(ClickFlag=="0")
         {
            ...
            SalesPerformanceQtnQuarter(datefmt(firstDay),datefmt(lastDay));
       }
      ...
      svg.selectAll("dot")  
        ...
        console.log(d.Month);   
           ...
           div.style("left", d3.event.pageX+10+"px");
              div.style("top", d3.event.pageY-25+"px");
              div.style("display", "inline-block");
              div.html("<span style='color:#ffffff'>" +"Bill Date Month: " +d.Month +"<br/>"+"ASP: " +commaFormat(d.Amo)+"</span>");             
            })          
        .on("mouseout", function(d) {   
            div1.transition()    
                .duration(500)    
