...
function Macv_SourceSite(spzone,Sstate,scity,Semp,SSite,Scate,prname,subcat,itemcode){
...
var pSsite=encodeURI("http://localhost/MACV/SalesRepInsight/data/SouceSite.php");
