...
function render_avgsession(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,itemcode){
 ...
 var SPQ=encodeURI("http://localhost/MACV/SalesRepInsight/data/SalesPerformanceQtn.php"); 
