$( document ).ready(function() { 
  ...
  //    ClickFlagV="3";
  //     //console.log("WWWW",ClickFlag);
  //     //console.log("FFFFF",ClickFlag1);
  //     $(this).remove(); 
...
function SalesPerformanceValueQuarter(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,itemcode){
