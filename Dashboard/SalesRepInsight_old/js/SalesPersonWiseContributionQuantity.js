...
function SalesPersonWiseContributionQuantity(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,itemcode)
      {
    ...
    var groupData = function(groupings, data, key){
      ...
      var SPWCQ=encodeURI("http://localhost/MACV/SalesRepInsight/data/SalesPersonWiseContributionQuantity.php"); 
