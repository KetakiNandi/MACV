...
function SalesPersonWiseUpsellingQnt(startDate,endDate,zone,state,city,SSite,prname,Scate,Semp,yesno,subcat,itemcode)
...
var Cvalue=encodeURI("http://localhost/MACV/SalesRepInsight/data/SalesPersonWiseUpSellingQtn.php");



if (zone === undefined && state === undefined && city === undefined  && Semp === undefined && SSite === undefined  && Scate === undefined && prname === undefined && startDate === undefined && endDate === undefined && yesno===undefined && subcat===undefined && itemcode===undefined)
   {
      links=(Cvalue+"?param=");
      //console.log("ddddddddddd",links);
   }

else if((zone)&& state === undefined && city === undefined  && Semp === undefined && SSite === undefined  && Scate === undefined && prname === undefined && startDate === undefined && endDate === undefined && yesno===undefined && subcat===undefined && itemcode===undefined)
    {
      links=(Cvalue+"?zoneparam="+zone);
    }

else if(zone === undefined && state && city === undefined  && Semp === undefined && SSite === undefined  && Scate === undefined && prname === undefined && startDate === undefined && endDate === undefined && yesno===undefined && subcat===undefined && itemcode===undefined)
    {
       links=(Cvalue+"?Stateparam="+state);

       
    }
else if(zone === undefined && state === undefined && city  && Semp === undefined && SSite === undefined  && Scate === undefined && prname === undefined && startDate === undefined && endDate === undefined && yesno===undefined && subcat===undefined && itemcode===undefined)
    {
        links=(Cvalue+"?Cityparam="+city);
    }
else if(zone === undefined && state === undefined && city === undefined  && Semp && SSite === undefined  && Scate === undefined && prname === undefined && startDate === undefined && endDate === undefined && yesno===undefined && subcat===undefined && itemcode===undefined)
    {
        links=(Cvalue+"?EmpIdparam="+Semp);
    }

else if(zone === undefined && state === undefined && city === undefined  && Semp === undefined && SSite  && Scate === undefined && prname === undefined && startDate === undefined && endDate === undefined && yesno===undefined && subcat===undefined && itemcode===undefined)
   {
      links=(Cvalue+"?Siteparam="+SSite);
   }

else if(zone === undefined && state === undefined && city === undefined  && Semp === undefined && SSite === undefined  && Scate  && prname === undefined && startDate === undefined && endDate === undefined && yesno===undefined && subcat===undefined && itemcode===undefined)
  {
  links=(Cvalue+"?categoryparam="+Scate);

 // console.log("ddddddddddd",links);
  }
  else if(zone === undefined && state === undefined && city === undefined  && Semp === undefined && SSite === undefined  && yesno  && prname === undefined && startDate === undefined && endDate === undefined && Scate===undefined && subcat===undefined && itemcode===undefined)
  {
  links=(Cvalue+"?YesNoparam="+yesno);

 // console.log("ddddddddddd",links);
  }
  else if(zone === undefined && state === undefined && city === undefined  && Semp === undefined && SSite === undefined  && subcat  && prname === undefined && startDate === undefined && endDate === undefined && Scate===undefined && yesno===undefined && itemcode===undefined)
  {
  links=(Cvalue+"?SubCatparam="+subcat);

 // console.log("ddddddddddd",links);
  }
   else if(zone === undefined && state === undefined && city === undefined  && Semp === undefined && SSite === undefined  && prname  && subcat === undefined && startDate === undefined && endDate === undefined && Scate===undefined && yesno===undefined && itemcode===undefined)
  {
  links=(Cvalue+"?ProNameparam="+prname);

 // console.log("ddddddddddd",links);
  }
  else if(zone === undefined && state === undefined && city === undefined  && Semp === undefined && SSite === undefined  && itemcode  && subcat === undefined && startDate === undefined && endDate === undefined && Scate===undefined && yesno===undefined && prname===undefined)
  {
