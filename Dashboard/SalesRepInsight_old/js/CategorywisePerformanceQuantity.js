...
function CategorywisePerformanceQuantity(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,itemcode){
     ...
     return d.data.Category });
        ...
        slice.on("click", function(d){
           ...
           Macv_Category(Zone,state,city,EmpID,SourceSite,d.data.Category);
            ...
            render_Tachievement(stDate,endDate,zone,state,city,SourceSite,promo,d.data.Category);
            SalesPersonWiseContributionQuantity(stDate,endDate,zone,state,city,SourceSite,promo,d.data.Category);
            SalesPersonWiseContributionValue(stDate,endDate,zone,state,city,SourceSite,promo,d.data.Category);
            PoSperformance(stDate,endDate,zone,state,city,SourceSite,promo,d.data.Category);
            SalesPersonWiseUpsellingQnt(stDate,endDate,zone,state,city,SourceSite,promo,d.data.Category);
