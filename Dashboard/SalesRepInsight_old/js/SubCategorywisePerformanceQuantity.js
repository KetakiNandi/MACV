...
function SubCategorywisePerformanceQuantity(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,itemcode){
   ...
   return {
    ...
    var text = svg.select(".labelName").selectAll("text")
           ...
           text.enter().append("text")
                ...
                pos[0] = radius *.35* (midAngle(d) < Math.PI ? 1.1 : -1.1);
