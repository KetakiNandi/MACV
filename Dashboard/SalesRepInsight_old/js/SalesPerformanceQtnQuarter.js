...
function SalesPerformanceQtnQuarter(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,itemcode){
...
var SPQQ=encodeURI("http://localhost/MACV/SalesRepInsight/data/SalesPerformanceQtnQuarter.php"); 
    ...
    else if(startDate === undefined && endDate === undefined && (promoname) && zone === undefined && state === undefined && city===undefined && sourceSite===undefined && catgory===undefined && emp===undefined && yesno===undefined && subcat===undefined && itemcode===undefined)
    {
          links=encodeURI(SPQQ+"?ProNameparam="+promoname);
         // console.log(links);
          d3.select("#ASU").remove();
    }
    else if(startDate === undefined && endDate === undefined && (catgory) && zone === undefined && state === undefined && city===undefined && sourceSite===undefined && promoname===undefined && emp===undefined && yesno===undefined && subcat===undefined && itemcode===undefined)
    {
          links=encodeURI(SPQQ+"?categoryparam="+catgory);
         // console.log(links);
          d3.select("#ASU").remove();
    }
    else if(startDate === undefined && endDate === undefined && (emp) && zone === undefined && state === undefined && city===undefined && sourceSite===undefined && promoname===undefined && catgory===undefined && yesno===undefined && subcat===undefined && itemcode===undefined)
    {
          links=encodeURI(SPQQ+"?EmpIdparam="+emp);
         // console.log(links);
          d3.select("#ASU").remove();
    }
    else if(startDate === undefined && endDate === undefined && (yesno) && zone === undefined && state === undefined && city===undefined && sourceSite===undefined && promoname===undefined && catgory===undefined && emp===undefined && subcat===undefined && itemcode===undefined)
    {
          links=encodeURI(SPQQ+"?YesNoparam="+yesno);
         // console.log(links);
          d3.select("#ASU").remove();
    }
    else if(startDate === undefined && endDate === undefined && (subcat) && zone === undefined && state === undefined && city===undefined && sourceSite===undefined && promoname===undefined && catgory===undefined && emp===undefined && yesno===undefined && itemcode===undefined)
    {
          links=encodeURI(SPQQ+"?SubCatparam="+subcat);
         // console.log(links);
          d3.select("#ASU").remove();
    }
    else if(startDate === undefined && endDate === undefined && (itemcode) && zone === undefined && state === undefined && city===undefined && sourceSite===undefined && promoname===undefined && catgory===undefined && emp===undefined && yesno===undefined && subcat===undefined)
    {
