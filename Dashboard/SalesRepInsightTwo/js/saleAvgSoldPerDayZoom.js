$( document ).ready(function() {	
    ...
    render_avgSoldPerDayZoom();

});

function render_avgSoldPerDayZoom(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,itemcode,POSType){
...
var div = d3.select("body").append("div").attr("class", "toolTip");
    ...
    var svg = d3.select("#SAQPZ").append("svg")
        .attr("id","SUPCZ")
        .attr("width", width)
        .attr("height", 495)
        .append("g")
    ...
    //svg.call(tip);
     ...
     var SAQPDLink = encodeURI("http://localhost/MACV/SalesRepInsightTwo/data/saleAvgQtnPerDay.php");
