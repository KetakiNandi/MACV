...
function Macv_Promoname(spzone,Sstate,scity,Semp,SSite,Scate,subcat,itemcode,POSType){
  ...
  //console.log(spzone,Sstate,scity,Semp,SSite,Scate,subcat,itemcode);
      ...
      var pName=encodeURI("http://localhost/MACV/SalesRepInsightTwo/data/promoName.php");



    
      if (spzone === undefined && Sstate === undefined && scity === undefined  && Semp === undefined  && SSite === undefined  && Scate === undefined && subcat===undefined && itemcode===undefined && POSType===undefined) {
       ...
       else if((spzone)&& Sstate === undefined && scity === undefined  && Semp === undefined && SSite === undefined  && Scate === undefined && subcat===undefined && itemcode===undefined && POSType===undefined)
          {
      ...
      else if(spzone === undefined && Sstate && scity === undefined  && Semp === undefined && SSite === undefined  && Scate === undefined && subcat===undefined && itemcode===undefined && POSType===undefined)
          {
      ...
      else if(spzone === undefined && Sstate === undefined && scity  && Semp === undefined && SSite === undefined  && Scate === undefined && subcat===undefined && itemcode===undefined && POSType===undefined)
        {
      ...
      else if(spzone === undefined && Sstate === undefined && scity === undefined  && Semp  && SSite === undefined  && Scate === undefined && subcat===undefined && itemcode===undefined && POSType===undefined)
      {
        links=encodeURI(pName+"?EmpIdparam="+Semp);
        //console.log(links);
      }

      else if (spzone === undefined && Sstate === undefined && scity === undefined  && Semp === undefined  && SSite  && Scate === undefined && subcat===undefined && itemcode===undefined && POSType===undefined)
      {
        links=encodeURI(pName+"?Siteparam="+SSite);
        //console.log(links);

      }
      else if (spzone === undefined && Sstate === undefined && scity === undefined  && Semp === undefined  && subcat  && Scate === undefined && SSite===undefined && itemcode===undefined && POSType===undefined)
      {
        links=encodeURI(pName+"?SubCatparam="+subcat);
       // console.log(links);

      }
      else if (spzone === undefined && Sstate === undefined && scity === undefined  && Semp === undefined  && itemcode  && Scate === undefined && SSite===undefined && subcat===undefined && POSType===undefined)
      {
        links=encodeURI(pName+"?itemcodeparam="+itemcode);
        //console.log(links);

      }
      else if (spzone === undefined && Sstate === undefined && scity === undefined  && Semp === undefined  && POSType  && Scate === undefined && SSite===undefined && subcat===undefined && itemcode===undefined)
      {
    ...
    d3.select('#someButton6')
      .on('click', function(d) {
	    ...
	    Macv_POSType(Zone,state,city,EmpID,SourceSite,Division,selectedValues);
	     ...
	     render_avgSoldPerDayZoom(stDate,endDate,zone,state,city,SourceSite,selectedValues);
	      ...
	      render_TachievementZoom(stDate,endDate,zone,state,city,SourceSite,selectedValues);
          SalesPersonWiseContributionQuantityZoom(stDate,endDate,zone,state,city,SourceSite,selectedValues);
          SalesPersonWiseContributionValueZoom(stDate,endDate,zone,state,city,SourceSite,selectedValues);
		...
		SalesPersonWiseUpsellingQntZoom(stDate,endDate,zone,state,city,SourceSite,selectedValues);
      }else
      {
          Macv_Zone(Zone,state,city,EmpID,SourceSite,Division,selectedValues);
          Macv_Category(Zone,state,city,EmpID,SourceSite,Division,selectedValues);
