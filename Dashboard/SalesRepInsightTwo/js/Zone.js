...
var pZone=encodeURI("http://localhost/MACV/SalesRepInsightTwo/data/Zone.php");
...
var endDate;
 ...
 var signal = d3.select('#MacDZ');
	...
	render_avgSoldPerDayZoom(stDate,endDate,selectedValues);
        render_TachievementZoom(stDate,endDate,selectedValues);
        SalesPersonWiseContributionQuantityZoom(stDate,endDate,selectedValues);
        SalesPersonWiseContributionValueZoom(stDate,endDate,selectedValues);
        SalesPersonWiseUpsellingQntZoom(stDate,endDate,selectedValues);    
