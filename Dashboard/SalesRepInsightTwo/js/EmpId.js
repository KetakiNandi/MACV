...
var SourceSite;
 ...
 var pEmpId=encodeURI("http://localhost/MACV/SalesRepInsightTwo/data/empID.php");
...
return "<form><input type=checkbox class=che  id=check ><span><button class=Macd >" + d.EmpName + "</button></span> </form>";
 ...
 .on("click", function(d){
  ...
  SalesPersonWiseUpsellingQnt(stDate,endDate,zone,state,city,SourceSite,promo,catgory,d.EmpID);
	...
	render_avgSoldPerDayZoom(stDate,endDate,zone,state,city,SourceSite,promo,catgory,d.EmpID);
  render_TachievementZoom(stDate,endDate,zone,state,city,SourceSite,promo,catgory,d.EmpID);
  SalesPersonWiseContributionQuantityZoom(stDate,endDate,zone,state,city,SourceSite,promo,catgory,d.EmpID);
  SalesPersonWiseContributionValueZoom(stDate,endDate,zone,state,city,SourceSite,promo,catgory,d.EmpID);
  SalesPersonWiseUpsellingQntZoom(stDate,endDate,zone,state,city,SourceSite,promo,catgory,d.EmpID);
