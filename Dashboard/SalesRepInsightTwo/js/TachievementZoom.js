$( document ).ready(function() {
    ...
    render_TachievementZoom();
});

function render_TachievementZoom(startDate,endDate,zone,state,city,sourceSite,promoname,catgory,emp,yesno,subcat,itemcode,POSType){
    ...
    var targetlink = encodeURI("http://localhost/MACV/SalesRepInsightTwo/data/Tachievement.php");
